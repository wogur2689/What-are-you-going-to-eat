...
public class MenuActivity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iv_roulette = findViewById(R.id.roulette_menu4); //애니메이션 이미지 인식
        ...
        btn.setOnClickListener(new View.OnClickListener() { //클릭 이벤트 처리기
            ...
            public void onClick(View view) {
                Intent it = new Intent(MenuActivity4.this, MapActivity.class);
                if(menu == "피자") {
